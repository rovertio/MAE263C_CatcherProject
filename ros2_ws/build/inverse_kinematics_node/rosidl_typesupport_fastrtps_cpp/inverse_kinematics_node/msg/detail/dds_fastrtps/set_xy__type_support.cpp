...
#include "inverse_kinematics_node/msg/detail/set_xy__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = inverse_kinematics_node::msg::SetXY;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const inverse_kinematics_node::msg::SetXY *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<inverse_kinematics_node::msg::SetXY *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetXY__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const inverse_kinematics_node::msg::SetXY *>(
...
static size_t _SetXY__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetXY(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetXY__callbacks = {
...
static rosidl_message_type_support_t _SetXY__handle = {
...
{
  return &inverse_kinematics_node::msg::typesupport_fastrtps_cpp::_SetXY__handle;
}
