...
class Metaclass_SetJointDegrees(type):
    """Metaclass of message 'SetJointDegrees'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'joint_positions_node.msg.SetJointDegrees')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__set_joint_degrees
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__set_joint_degrees
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__set_joint_degrees
            cls._TYPE_SUPPORT = module.type_support_msg__msg__set_joint_degrees
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__set_joint_degrees
...
class SetJointDegrees(metaclass=Metaclass_SetJointDegrees):
    """Message class 'SetJointDegrees'."""
