...
static const _GetJointDegrees_Request_type_support_symbol_names_t _GetJointDegrees_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, joint_positions_node, srv, GetJointDegrees_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, joint_positions_node, srv, GetJointDegrees_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, joint_positions_node, srv, GetJointDegrees_Request)() {
  return &::joint_positions_node::srv::rosidl_typesupport_c::GetJointDegrees_Request_message_type_support_handle;
}
...
static const _GetJointDegrees_Response_type_support_symbol_names_t _GetJointDegrees_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, joint_positions_node, srv, GetJointDegrees_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, joint_positions_node, srv, GetJointDegrees_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, joint_positions_node, srv, GetJointDegrees_Response)() {
  return &::joint_positions_node::srv::rosidl_typesupport_c::GetJointDegrees_Response_message_type_support_handle;
}
...
static const _GetJointDegrees_type_support_symbol_names_t _GetJointDegrees_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, joint_positions_node, srv, GetJointDegrees)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, joint_positions_node, srv, GetJointDegrees)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, joint_positions_node, srv, GetJointDegrees)() {
  return &::joint_positions_node::srv::rosidl_typesupport_c::GetJointDegrees_service_type_support_handle;
}
