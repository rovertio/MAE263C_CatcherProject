...
static const _SetPositions_type_support_symbol_names_t _SetPositions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dual_dynamixel_node, msg, SetPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dual_dynamixel_node, msg, SetPositions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dual_dynamixel_node, msg, SetPositions)() {
  return &::dual_dynamixel_node::msg::rosidl_typesupport_c::SetPositions_message_type_support_handle;
}
