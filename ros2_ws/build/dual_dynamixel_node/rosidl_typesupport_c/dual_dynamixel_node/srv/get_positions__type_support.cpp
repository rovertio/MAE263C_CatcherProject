...
static const _GetPositions_Request_type_support_symbol_names_t _GetPositions_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dual_dynamixel_node, srv, GetPositions_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dual_dynamixel_node, srv, GetPositions_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dual_dynamixel_node, srv, GetPositions_Request)() {
  return &::dual_dynamixel_node::srv::rosidl_typesupport_c::GetPositions_Request_message_type_support_handle;
}
...
static const _GetPositions_Response_type_support_symbol_names_t _GetPositions_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dual_dynamixel_node, srv, GetPositions_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dual_dynamixel_node, srv, GetPositions_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dual_dynamixel_node, srv, GetPositions_Response)() {
  return &::dual_dynamixel_node::srv::rosidl_typesupport_c::GetPositions_Response_message_type_support_handle;
}
...
static const _GetPositions_type_support_symbol_names_t _GetPositions_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dual_dynamixel_node, srv, GetPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dual_dynamixel_node, srv, GetPositions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dual_dynamixel_node, srv, GetPositions)() {
  return &::dual_dynamixel_node::srv::rosidl_typesupport_c::GetPositions_service_type_support_handle;
}
