...
bool dual_dynamixel_node__srv__get_positions__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dual_dynamixel_node.srv._get_positions.GetPositions_Request", full_classname_dest, 59) == 0);
  }
  dual_dynamixel_node__srv__GetPositions_Request * ros_message = _ros_message;
  {  // id
...
PyObject * dual_dynamixel_node__srv__get_positions__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dual_dynamixel_node.srv._get_positions");
...
ROSIDL_GENERATOR_C_EXPORT
bool dual_dynamixel_node__srv__get_positions__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dual_dynamixel_node.srv._get_positions.GetPositions_Response", full_classname_dest, 60) == 0);
  }
  dual_dynamixel_node__srv__GetPositions_Response * ros_message = _ros_message;
  {  // position
