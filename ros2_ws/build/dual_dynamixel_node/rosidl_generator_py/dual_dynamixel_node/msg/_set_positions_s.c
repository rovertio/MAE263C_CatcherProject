...
bool dual_dynamixel_node__msg__set_positions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dual_dynamixel_node.msg._set_positions.SetPositions", full_classname_dest, 51) == 0);
  }
  dual_dynamixel_node__msg__SetPositions * ros_message = _ros_message;
  {  // id
...
PyObject * dual_dynamixel_node__msg__set_positions__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dual_dynamixel_node.msg._set_positions");
