...
#ifndef DUAL_DYNAMIXEL_NODE__SRV__DETAIL__GET_POSITIONS__FUNCTIONS_H_
#define DUAL_DYNAMIXEL_NODE__SRV__DETAIL__GET_POSITIONS__FUNCTIONS_H_
 ...
 * calls
 * dual_dynamixel_node__srv__GetPositions_Request__init().
...
/**
 * It calls
 * dual_dynamixel_node__srv__GetPositions_Request__fini()
 ...
 * dual_dynamixel_node__srv__GetPositions_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dual_dynamixel_node__srv__GetPositions_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dual_dynamixel_node__srv__GetPositions_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dual_dynamixel_node
...
/**
 * It calls
 * dual_dynamixel_node__srv__GetPositions_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dual_dynamixel_node
...
/**
 * It allocates the memory for the array and calls
 * dual_dynamixel_node__srv__GetPositions_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dual_dynamixel_node
...
/**
 * It calls
 * dual_dynamixel_node__srv__GetPositions_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DUAL_DYNAMIXEL_NODE__SRV__DETAIL__GET_POSITIONS__FUNCTIONS_H_
